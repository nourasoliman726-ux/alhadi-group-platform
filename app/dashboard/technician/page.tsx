...
const mockRequests = [
  {
    ...
    description:      "انقطع التيار الكهربائي في الصالة ولوحة الكهرباء تعطل",
    urgency:          "urgent",
    status:           "pending",
  ...
  },
  {
    ...
    sub_service:      "تركيب كاميرات خارجية",
    description:      "تركيب 4 كاميرات مراقبة خارجية للفيلا",
    urgency:          "normal",
    status:           "assigned",
  ...
  },
  {
    ...
    sub_service:      "تمديد شبكات إنترنت",
  ...
  },
  {
    ...
    description:      "تبديل كابلات المطبخ بالكامل",
    urgency:          "normal",
    status:           "completed",
...
export default function TechnicianDashboard() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    if (
      loginData.email    === "technician@alhadi.com" &&
      loginData.password === "tech123"
    ) {
      setIsLoggedIn(true);
      setLoginError("");
    } else {
      ...
      >
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <div
              ...
              style={{
                ...
                border: "2px solid rgba(232,237,243,0.2)",
              }}
            >
          ...
          >
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="technician@alhadi.com"
            ...
            >
              للتجربة: technician@alhadi.com / tech123
            </div>
          </div>
        </div>
      </div>
              ...
              >
                ...
                >
                  ...
                  <button
                    ...
                    style={{ backgroundColor: "#e8edf3" }}
                  >
                    <XCircle size={14} style={{ color: "#1e3a5f" }} />
                  </button>
                </div>
                ...
                <div className="p-5 space-y-5">
                  ...
                  <div>
                    ...
                    <div className="space-y-2.5">
                      {[
                        { icon: User,   label: "الاسم",   value: selectedReq.client_name },
                    ...
                    >
                      <div className="flex justify-between text-sm">
                        ...
                        <span
                          ...
                          style={{ color: "#0f1b3d" }}
                        >
                          {categoryLabels[selectedReq.service_category]}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
